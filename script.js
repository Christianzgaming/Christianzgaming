...
async function jawab(){
  var { value: jawaban } = await swals.fire({
    title: 'Sumulat ng Mensahe &#128073;&#128072;', input: 'text', allowOutsideClick: false, showCancelButton: false,
  });
  if(jawaban && jawaban.length < 19){
    ...
    await swals.fire('opps!', 'Ang mga sagot ay hindi maaaring walang laman o mas mahaba sa 18 character, OK!');jawab();
  }
}
